...
export const phrases: Phrase[] = [
  { id:'yes', category:'quick', ru:'Да', zh:'是的', pinyin:'shì de', audio:'assets/audio/phrases/quick/yes.mp3' },
  { id:'no', category:'quick', ru:'Нет', zh:'不是', pinyin:'bú shì', audio:'assets/audio/phrases/quick/no.mp3' },
  { id:'okay', category:'quick', ru:'Хорошо', zh:'好的', pinyin:'hǎo de', audio:'assets/audio/phrases/quick/okay.mp3' },
  { id:'wait', category:'quick', ru:'Подождите', zh:'请等一下', pinyin:'qǐng děng yí xià', audio:'assets/audio/phrases/quick/wait-please.mp3' },
  { id:'again', category:'quick', ru:'Повторите, пожалуйста', zh:'请再说一遍', pinyin:'qǐng zài shuō yí biàn', audio:'assets/audio/phrases/quick/repeat-please.mp3' },
  { id:'this-one', category:'quick', ru:'Вот это', zh:'我要这个', pinyin:'wǒ yào zhè ge', audio:'assets/audio/phrases/quick/this-one.mp3' },
  { id:'dont-need', category:'quick', ru:'Не нужно', zh:'不需要', pinyin:'bù xū yào', audio:'assets/audio/phrases/quick/i-do-not-need-it.mp3' },
  { id:'can', category:'quick', ru:'Можно', zh:'可以', pinyin:'kě yǐ', audio:'assets/audio/phrases/quick/yes-you-can.mp3' },
  ...
  { id:'mango', category:'fruit', ru:'Манго', zh:'芒果', pinyin:'máng guǒ', audio:'assets/audio/phrases/fruit/mango.mp3' },
  { id:'mangosteen', category:'fruit', ru:'Мангостин', zh:'山竹', pinyin:'shān zhú', audio:'assets/audio/phrases/fruit/mangosteen.mp3' },
  { id:'rambutan', category:'fruit', ru:'Рамбутан', zh:'红毛丹', pinyin:'hóng máo dān', audio:'assets/audio/phrases/fruit/rambutan.mp3' },
  { id:'dragon-fruit', category:'fruit', ru:'Драконий фрукт', zh:'火龙果', pinyin:'huǒ lóng guǒ', audio:'assets/audio/phrases/fruit/dragon-fruit.mp3' },
  { id:'coconut', category:'fruit', ru:'Кокос', zh:'椰子', pinyin:'yē zi', audio:'assets/audio/phrases/fruit/coconut.mp3' },
  { id:'pineapple', category:'fruit', ru:'Ананас', zh:'菠萝', pinyin:'bō luó', audio:'assets/audio/phrases/fruit/pineapple.mp3' },
  { id:'watermelon', category:'fruit', ru:'Арбуз', zh:'西瓜', pinyin:'xī guā', audio:'assets/audio/phrases/fruit/watermelon.mp3' },
  { id:'durian', category:'fruit', ru:'Дуриан', zh:'榴莲', pinyin:'liú lián', audio:'assets/audio/phrases/fruit/durian.mp3' },
  { id:'lychee', category:'fruit', ru:'Личи', zh:'荔枝', pinyin:'lì zhī', audio:'assets/audio/phrases/fruit/lychee.mp3' },
  { id:'cut-fruit', category:'fruit', ru:'Нарежьте фрукты, пожалуйста', zh:'请帮我切一下水果', pinyin:'qǐng bāng wǒ qiē yí xià shuǐ guǒ', audio:'assets/audio/phrases/fruit/cut-the-fruit-please.mp3' },
